<!DOCTYPE html>
<html lang="en" data-random-animation="false" data-animation="33">
    
<!-- Mirrored from watson-vcard.netlify.com/index-dark-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Sep 2018 19:16:12 GMT -->
...
<!--Main Styles Css-->
<link rel="stylesheet" href="{{asset('public/frontend/css/style-dark.css')}}">

<link rel="stylesheet" href="{{asset('public/frontend/css/style-demo.css')}}">

<!--Color Css-->
<link class="site-color" rel="stylesheet" href="{{asset('public/frontend/css/blue-color.css')}}">
...
<div class="theme-options dark">
    ...
    <div class="theme-menu">
        ...
        <div class="theme-color">
            ...
            <ul>
                <li><a href="{{asset('public/frontend/css/blue-color.css')}}" style="background-color: #00A3E1;;"></a></li>
                <li><a href="{{asset('public/frontend/css/red-color.css')}}" style="background-color: #E82A2A;"></a></li>
                <li><a href="{{asset('public/frontend/css/green-color.css')}}" style="background-color: #6ac045;"></a></li>
                <li><a href="{{asset('public/frontend/css/yellow-color.css')}}"style="background-color: #D1A71D;"></a></li>
                <li><a href="{{asset('public/frontend/css/pink-color.css')}}" style="background-color: #FF1493;"></a></li>
                <li><a href="{{asset('public/frontend/css/purple-color.css')}}" style="background-color: #5078FF;"></a></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="header-content">
            ...
            <div class="header-main" data-simplebar>
                <div class="image-container">
                    ...
                    <img src="{{asset('public/frontend/img/profile-img.jpg')}}" alt="profile-pic">
                </div>
            ...
            <div class="banner-slider">
                <div id="slides">
                    <div class="slides-container">
                        <!--Slide 1-->
                        <img src="{{asset('public/frontend/img/slider/img-1.jpg')}}" alt="">
                        <!--Slide 2-->
                        <img src="{{asset('public/frontend/img/slider/img-2.jpg')}}" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="row about mb-70">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="signature mt-20">
                            <img src="{{asset('public/frontend/img/signature-white.png')}}" alt="">
                        </div>
                    </div>
                ...
                <div class="row clients mb-70">
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-01.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-02.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-03.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-04.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-05.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-06.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-07.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-08.png')}}" alt="">
                            </a>
                        </div>
                        ...
                        <div class="client-logo">
                            <a href="#">
                                <img src="{{asset('public/frontend/img/clients/client-09.png')}}" alt="">
                            </a>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-meta">
                                    <img src="{{asset('public/frontend/img/testimonials/author-2.jpg')}}" alt="">
                                    <div class="meta-info">
                                        <h4>Emma Jones</h4>
                            ...
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-meta">
                                    <img src="{{asset('public/frontend/img/testimonials/author-3.jpg')}}" alt="">
                                    <div class="meta-info">
                                        <h4>Jack Smith</h4>
                ...
                <div class="row portfolio-items mb-50">
                    ...
                    <div class="item col-lg-4 col-sm-6 brand graphic">
                        <a class="image-link" href="img/portfolio/img-1.jpg">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-1.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Book Design</h4>
                                    <p>Graphic</p>
                                </figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 design">
                        <a class="ajax-link" href="single-work.html">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-2.jpg')}}" alt="">
                                <figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 design graphic">
                        <a class="video-link" href="https://www.youtube.com/watch?v=k_okcNVZqqI">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-3.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Creative Cup</h4>
                                    <p>Graphic</p>
                                </figcaption>
                    ...
                    <!--Portfolio Item-->
                    <div class="item col-lg-4 col-sm-6 design">
                        <a class="image-link" href="{{asset('public/frontend/img/portfolio/img-4.jpg')}}">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-4.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Business Card</h4>
                                    <p>Design</p>
                                </figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 brand">
                        <a class="ajax-link" href="single-work.html">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-5.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Back Pack</h4>
                                    <p>Brand</p>
                                </figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 design">
                        <a class="ajax-link" href="single-work.html">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-6.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Door Hangar</h4>
                                    <p>Design</p>
                                </figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 graphic">
                        <a class="image-link" href="img/portfolio/img-7.jpg">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-7.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Notepad Design</h4>
                                    <p>graphic</p>
                                </figcaption>
                    ...
                    <!--Portfolio Item-->
                    <div class="item col-lg-4 col-sm-6 brand">
                        <a class="image-link" href="single-work.html">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-8.jpg')}}" alt="">
                                <figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 brand">
                        <a class="video-link" href="https://www.youtube.com/watch?v=k_okcNVZqqI">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-9.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Mobile App</h4>
                                    <p>Brand</p>
                                </figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 graphic">
                        <a class="image-link" href="single-work.html">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-10.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Cup Design</h4>
                                    <p>Graphic</p>
                                </figcaption>
                    ...
                    <div class="item col-lg-4 col-sm-6 brand graphic">
                        <a class="ajax-link" href="single-work.html">
                            <figure>
                                <img src="{{asset('public/frontend/img/portfolio/img-11.jpg')}}" alt="">
                                <figcaption>
                                    <h4>Creative Box</h4>
                                    <p>brand</p>
                                </figcaption>
            ...
            <div class="section-container">
                ...
                <div class="row blogs-masonry">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-3.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-4.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-5.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                                <span class="cat">Web Design</span>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-6.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-7.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-8.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                                <span class="cat">Technology</span>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="blog-dark.html" class="blog-item">
                            <div class="blog-image">
                                <img src="{{asset('public/frontend/img/blog/img-9.jpg')}}" alt="#">
                            </div>
                            <div class="blog-content">
                                <span class="cat">Traveling</span>
...
<script src="{{asset('public/frontend/js/main-demo.js')}}"></script>
...
<!-- Mirrored from watson-vcard.netlify.com/index-dark-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Sep 2018 19:16:28 GMT -->
</html>
